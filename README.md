...
Yijia Chen, Ze Zhang, Hanwen Zhang, Jiaqi Yang,Bingye Zhou, **Zhong Yuan*** , KSLFN: Kernel Self-representation Learning based Fuzzy Neighborhood outlier detection.
